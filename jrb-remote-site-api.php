...
add_action('rest_api_init', function() {
    ...
    register_rest_route('jrb-remote/v1', '/ping', [
        'methods' => 'GET',
    ...
    // Site info
    register_rest_route('jrb-remote/v1', '/site', [
        'methods' => 'GET',
    ...
    // Posts
    register_rest_route('jrb-remote/v1', '/posts', [
        'methods' => 'GET',
    ...
    register_rest_route('jrb-remote/v1', '/posts/(?P<id>\d+)', [
        'methods' => 'PUT',
    ...
    // Categories
    register_rest_route('jrb-remote/v1', '/categories', [
        'methods' => 'GET',
    ...
    // Tags
    register_rest_route('jrb-remote/v1', '/tags', [
        'methods' => 'GET',
    ...
    // Media
    register_rest_route('jrb-remote/v1', '/media', [
        'methods' => 'GET',
    ...
    // Pages
    register_rest_route('jrb-remote/v1', '/pages', [
        'methods' => 'GET',
    ...
    // Users
    register_rest_route('jrb-remote/v1', '/users', [
        'methods' => 'GET',
    ...
    register_rest_route('jrb-remote/v1', '/plugins/search', [
        'methods' => 'GET',
...
function openclaw_verify_token() {
    ...
    if (empty($token_hash) && empty($legacy_token)) {
        return new WP_Error('no_token', 'API token not configured. Go to Settings → JRB Remote Site API.', ['status' => 500]);
    }
...
add_action('admin_menu', function() {
    add_options_page('JRB Remote Site API', 'JRB Remote Site API', 'manage_options', 'openclaw-api', 'openclaw_api_admin_page');
});
...
function openclaw_api_admin_page() {
    ...
    https://yoursite.com/wp-json/jrb-remote/v1/site</pre>
            <?php
...
/**
 * INTEGRATION: Loading Modern Modules (v5.1.2)
 * This ensures FluentCRM, Support, and Community modules are active.
 */
